...
La tabella seguente elenca le modifiche ai comandi CLI e Script per la release 12.00.
...
| Comando | Descrizione della modifica 
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-host-io-protocol.html["Imposta il protocollo I/O host dell'array di storage"]
 a| 
Comando aggiunto.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/show-storage-array-host-io-protocol.html["Mostra le informazioni sul protocollo I/O host dell'array di storage"]
 a| 
Comando aggiunto.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/start-storagearray-externalkeymanagement-test.html["Verificare la comunicazione esterna di gestione delle chiavi"]
 a| 
Aggiunti i risultati del test di comunicazione KMS all'output del comando.



 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-managementinterface.html["Impostare l'interfaccia di gestione degli array di storage"]
 a| 
Comando rimosso.
...
Aggiornato `disableResourceProvisioning` descrizione del parametro.
 ...
 a| 
xref:./commands-a-z/recreate-storagearray-securitykey.adoc[Ricreare la chiave di sicurezza esterna]
 a| 
