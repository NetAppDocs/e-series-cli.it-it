...
summary: 'Il comando set drive operationalState imposta un disco sullo stato Failed (guasto).' 
---
= Imposta lo stato dell'unità - CLI SANtricity
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il `set drive operationalState` Il comando imposta un disco sullo stato Failed (guasto).
...
Per riportare un disco allo stato ottimale, utilizzare `revive drive` comando.
