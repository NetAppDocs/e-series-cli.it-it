...
Se la gestione delle chiavi esterne è abilitata, questo comando si applica solo agli array E4000, E2800, E5700, EF600, EF300, EF50 o EF80. Se la gestione delle chiavi interne è abilitata, il comando si applica a qualsiasi array di storage, a condizione che tutti i pacchetti SMcli siano installati.
