...
summary: Il comando set drive hotspare assegna o disassegna uno o più dischi come hot spare. 
---
= Imposta hot spare dell'unità - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il `set drive hotSpare` il comando assegna o disassegna uno o più dischi come hot spare.
...
`hotSpare`
 a| 
L'impostazione per assegnare il disco come hot spare. Per assegnare l'unità come hot spare, impostare questo parametro su `TRUE`. Per rimuovere un'assegnazione hot spare da un disco, impostare questo parametro su `FALSE`.
