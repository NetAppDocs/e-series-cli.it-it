...
Tutti i valori massimi degli slot ID sono 24. I valori degli slot ID iniziano da 0 o da 1, a seconda del modello del vassoio. I vassoi per unità compatibili con i controller E2800, E5700, EF600, EF300, EF50 e EF80 hanno numeri di slot ID che iniziano da 0. I vassoi per unità compatibili con i controller E2700 e E5600 hanno numeri di slot ID che iniziano da 1.
