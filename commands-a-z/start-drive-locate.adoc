...
summary: Il comando START Drive Locate individua un disco accendendo una spia luminosa sul disco. 
---
= Avvia la localizzazione dell'unità - CLI SANtricity
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il `start drive locate` il comando individua un'unità accendendo una spia sull'unità.
...
Eseguire `stop drive locate` comando per spegnere l'indicatore luminoso sul disco.
