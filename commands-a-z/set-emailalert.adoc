...
Questo comando si applica agli array di storage E4000, E2800, E5700, EF600, EF300, EF50 e EF80. Tuttavia, puoi utilizzare il comando come comando SMcli, non come comando di script, per gli array E2700 o E5600. In questo caso, il comando si applica a tutti gli array nel dominio di gestione.
