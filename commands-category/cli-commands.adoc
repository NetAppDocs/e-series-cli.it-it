...
summary: 'Comandi CLI (elenco alfabetico)' 
---
= Comandi CLI (elenco alfabetico)
:allow-uri-read: 


[role="lead"]
Segue un elenco completo di comandi disponibili per il tuo sistema storage e-Series.
...
link:../commands-a-z/set-storagearray-autosupportremotediag.html["Attiva o disattiva la funzione di diagnostica remota AutoSupport"]
...
link:../commands-a-z/save-storagearray-keymanagementcertificate.html["Recuperare la richiesta CSR di gestione delle chiavi installate"]
