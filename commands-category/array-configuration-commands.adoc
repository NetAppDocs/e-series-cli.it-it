...
link:../commands-a-z/set-storagearray-host-io-protocol.html["Imposta il protocollo I/O host dell'array di storage"]
...
link:../commands-a-z/show-storage-array-host-io-protocol.html["Mostra il protocollo I/O host dell'array di storage"]
